...
-- DOES THIS CORRESPOND TO TRANSPARENT AND OPAQUE MODULE ASCRIPTIONS IN OCAML?
...
Definition conj_fact' : forall P Q R, P /\ Q -> Q /\ R -> P /\ R.
  intros. inversion H. inversion H0. split. apply H1. apply H4. Defined.

(* COMMENT: CAN WE PROVIDE A DIRECT PROOF OBJECT FOR THIS? IF SO HOW DO WE AND
WHAT DO WE MATCH ON???*)

(* Definition conj_fact2: forall P Q R,  P /\ Q -> Q /\ R -> P /\ R := *)
(*   match conj P Q with *)
(*     | P /\ _ => match conj Q R with *)
(*               | _ /\ R => conj P Q *)
(*               end *)
(*   end. *)
(** [] *)
...
(*EX INTRO TAKES THE PROPERTY, THEN THE WITNESS, THEN THE PROOF*)
